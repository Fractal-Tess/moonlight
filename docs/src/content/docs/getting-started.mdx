...
description: Learn how to use the Starlight Moonlight theme in your documentation.
---
...
1. The Starlight Moonlight theme is a Starlight [plugin](https://starlight.astro.build/reference/plugins/) that you can install using your favorite package manager:

   <PackageManagers pkg="starlight-theme-moonlight" />
...
That's it! You should now see the Starlight Moonlight theme applied to your Starlight website.
